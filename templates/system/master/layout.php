...
$res->addJs('/resources/master-theme/js/Application.js', -1);
...
$res->addJs('/resources/master-theme/theme-master.js', 3, true, 'head');
...
$res->addCss('/resources/master-theme/resources/theme-master-all.css', 100);
$res->addCss('/css/system/style.css', 2);
$res->addCss('/resources/master-theme/css/style.css', 3);
